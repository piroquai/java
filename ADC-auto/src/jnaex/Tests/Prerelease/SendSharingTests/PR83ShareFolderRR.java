 ...
 */
public class PR83ShareFolderRR implements ITest{
    ...
    public void performTest(Vector<String> buf){
        Proc.setBuf(buf);
        Proc.setGLP(" PR83ShareFolderRR");
        Proc.setLogScenarioPrefix("PR83");
        log(" PR83ShareFolderRR");
        try{
...
//            SimpleDateFormat fd = new SimpleDateFormat("yyyy_MM_dd_hh_mm_ss");
            //String R_email = CommonTestBlock.emailSSRF8Prefix + fd.format(d) + "_RRreceive" + CommonTestBlock.emailSSRF8Suffix;
//            String R_email = "evtitova+aut2017_12_07_10_24_51_RRreceive@siber.com";
//            String R_password = "qwerty";
//            SSTestBlock.emailRReceive = R_email;
//            SSTestBlock.passwRReceive = R_password;
            ...
            //SSTestBlock.nameSFolder = "nameNewFolder";
            ...
            sleepy(3);
            //SSTestBlock.roleConformationSender(SSTestBlock.nameSFolder, "Regular");
            sleepy(3);
