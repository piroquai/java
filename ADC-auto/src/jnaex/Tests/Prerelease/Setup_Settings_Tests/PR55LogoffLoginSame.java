 ...
 */
public class PR55LogoffLoginSame implements ITest{
    ...
    public void performTest(Vector<String> buf){
        Proc.setBuf(buf);
        Proc.setGLP("5.5 Setup (settings)");
        Proc.setLogScenarioPrefix("PR55");
        log("Logoff and login to the same account");
        try{
...
//            }
            ...
            EditorProc.changeAccount(UserProc.getUser());
            sleepy(3);
