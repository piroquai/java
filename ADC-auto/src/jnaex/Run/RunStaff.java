...
import jnaex.Tests.Prerelease.Extension.Chrome.ChromeNM;
import jnaex.Tests.Utils.EdgeTop100;
...
//        Test addUsersOnRFOAdmin = new Test("Add users on RFO admin");
//        performTest(new AddUsersOnRFOAdmin(),buf,addUsersOnRFOAdmin);
//        set.addTest(addUsersOnRFOAdmin);

        Proc.preinstallRF = false;
        Test chromeExt = new Test("Chrome extension basic functionality");
        performTest(new ChromeNM(),buf,chromeExt);
        set.addTest(chromeExt);
